...
function App() {
  ...
  const text = {
    ...
    es: {
      ...
      navStory: 'Historia',
      navContact: 'Contacto',
      heroEyebrow: 'Productos Frescos de Granja',
      heroTitle: 'Limas premium, leche y queso de la Finca Florlima.',
      heroText:
        'Finca Florlima trae productos naturales y premium directamente de nuestra granja familiar a tu hogar. Limas frescas, deliciosa leche y queso de vaca, y artesanal leche y queso de cabra. Simple, puro y listo para tu cocina.',
      ...
      lactoseFreeMilk: 'Limas Frescas',
      lactoseFreeMilkDesc: 'Limas brillantes y jugosas recién cosechadas de nuestro huerto. Perfectas para cocinar y bebidas.',
